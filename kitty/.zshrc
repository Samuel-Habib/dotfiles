...
export STM32CubeMX_PATH=/Applications/STMicroelectronics/STM32CubeMX.app/Contents/Resourcesexport PATH="/opt/homebrew/opt/llvm/bin:$PATH"
export PATH="$HOME/.local/xPacks/@xpack-dev-tools/arm-none-eabi-gcc/*/.content/bin:$PATH"
export PATH="$(ls -d $HOME/Library/xPacks/@xpack-dev-tools/arm-none-eabi-gcc/*/.content/bin | tail -1):$PATH"
